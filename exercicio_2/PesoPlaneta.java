...
double pUrano=0.0;
    ...
    v1 = Double.parseDouble(valor1.getText());
        ...
        if(mercurio.isSelected()){
            pMercurio=((v1/10)*0.37);
                JOptionPane.showMessageDialog(null, "O seu peso em Mercurio e: "+pMercurio);
        }
        if(marte.isSelected()){
            pMarte=((v1/10)*0.38);
                JOptionPane.showMessageDialog(null, "O seu peso em Marte e: "+pMarte);
        }
        if(saturno.isSelected()){
            pSaturno=((v1/10)*1.15);
                JOptionPane.showMessageDialog(null, "O seu peso em Saturno e: "+pSaturno);
        }
        
        if(venus.isSelected()){
            pVenus=((v1/10)*0.88);
                JOptionPane.showMessageDialog(null, "O seu peso em Venus e: "+pVenus);
        }
        if(jupiter.isSelected()){
            pJupiter=((v1/10)*2.64);
                JOptionPane.showMessageDialog(null, "O seu peso em Venus e: "+pJupiter);
        }
        if(urano.isSelected()){
            pUrano=((v1/10)*1.17);
                JOptionPane.showMessageDialog(null, "O seu peso em Urano e: "+pUrano);
        }        
